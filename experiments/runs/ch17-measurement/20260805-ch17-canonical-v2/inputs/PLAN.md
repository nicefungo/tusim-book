...
## 9. Session rule after Chapter 16

Chapter 16 is complete locally. Chapter 17 — Measurement Surfaces: Counters, Tracing, Cycle Models, and Energy — is next and must begin with fresh framing against `PLAN.md`, the post-Chapter-16 coverage review, and pinned producer/caller/archive/config/test evidence. Do not combine performance counters, traces, cycle models, energy estimates, or Chapter 16 controller ledgers into a fictional common clock. Publication remains approval-gated: request explicit user authorization before any rebuild-tree update or push to `origin/main`.
