...
pred('sram-total-size-save-gap','dst->total_size' not in copy_surface and all(x in restore_surface for x in ['rw->total_size = sw->total_size','ra->total_size = sa->total_size','ro->total_size = so->total_size']))
