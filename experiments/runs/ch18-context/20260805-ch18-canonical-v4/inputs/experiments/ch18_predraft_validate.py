...
RUN_ID=os.environ.get('CH18_RUN_ID','20260805-ch18-canonical-v4')
...
for phrase in ['32 implementation','147 structural','179 checks','Drafting remains blocked','exact model values']:
