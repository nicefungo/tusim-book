...
**Global decision:** the current chapter boundary and order remain valid; no `PLAN.md` amendment is warranted before evidence sealing. If the audit establishes a real ordinary-operation bridge or invalidates the single reader decision, drafting remains blocked until a dated plan amendment records the change.
