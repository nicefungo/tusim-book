...
for claim in ("C15.1","C15.28","C15.29","C15.30","C15.31","C15.32","C15.33","C15.34"): assert claim in ledger
...
expected={f"inputs/{x.as_posix()}" for x in INPUTS}|{
 ...
 "test-dram-mutation.log","ch15-probe.log",
