...
RUN_ID="${CH15_RUN_ID:-20260804-ch15-canonical-v2}"
...

{
  ...
  grep -q "CH15_SOURCE_AUDIT PASS pin=$PIN hashes=17 predicates=53 checks=70" "$RUN_DIR/source-audit.log"
  ...
  for exe in ch15-test-dram ch15-test-memhier ch15-probe; do
