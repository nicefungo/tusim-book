# Chapter 21 — Binding Limitation Register

These sentences are verbatim drafting bounds, keyed to the Chapter 21 claim ledger. Paraphrase may explain them but may not replace or weaken them.
...
- **C21.5:** context rows are uncalibrated model cycles at a caller-established legal boundary; CONTROL_ONLY’s 100 cycles omit reload, backing-store, queueing, drainage, and continuation correctness.
