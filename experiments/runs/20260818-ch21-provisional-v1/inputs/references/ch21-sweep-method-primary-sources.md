...
- Chapter 20 owns whether controls, status propagation, mutations, and provenance authorize a claim.
- Chapter 21 owns controlled matrices, workload/alternative selection, sensitivity, counterexamples, Pareto-bounded decisions, and reproducible sweep packaging.
- Chapter 22 alone owns portfolio-wide conclusions about preferable Tusim architecture regimes.
