...
body() {
    ...
    for member in tu_int_quant.o sparsity/structured_2of4.o memory/weight_compress.o; do
...
PY
    ...
    set -e
    [[ $MUTANT_RC -ne 0 ]]
    grep -Fq 'Tests: 27 run, 26 passed, 1 failed' "$RUN_DIR/test-sparsity-mutation.log"
