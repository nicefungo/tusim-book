...
- **Current canonical target:** `experiments/runs/ch12-multicore-interconnect/20260728-ch12-canonical-v4`
...
**Disposition:** **Qualified.** Retention and direct consumer behavior remain separate claims because canonical-v4 does not add one-field-at-a-time parse→convert→construct→effect checks.
...
**Disposition:** **Resolved.** The probe retained by canonical-v4 compares descriptor fields individually, initializes config state, and stops dependent checks after parse failure.
...
**Current verdict:** **BLOCK pending canonical-v4.** Canonical-v3 corrected the heuristic classification but later manuscript/reproducibility review found arithmetic-qualification and bundle-closure defects. Canonical-v2 and v3 remain immutable historical evidence; neither is the closure seal.
