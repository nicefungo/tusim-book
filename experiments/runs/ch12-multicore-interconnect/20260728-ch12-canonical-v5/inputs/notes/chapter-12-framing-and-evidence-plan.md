...
Canonical run target: `experiments/runs/ch12-multicore-interconnect/20260728-ch12-canonical-v5/`
...
7. Use only bounded, in-range communication probes. Treat send-span wraparound, mesh-column numerator overflow, final shared-score addition overflow, and thread-safety claims statically; do not execute undefined behavior or concurrent global swaps.
...
Drafting and closure are reopened after the independent technical, editorial, and reproducibility reviews returned BLOCK. Canonical-v4 must seal the corrected arithmetic predicates, retained pre-draft validation, and outer bundle manifest before approval.
