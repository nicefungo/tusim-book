...
RUN_ID = os.environ.get("CH12_RUN_ID", "20260728-ch12-canonical-v5")
...
assert "Current verdict:** **BLOCK pending canonical-v5" in dispositions
assert "### R22" in dispositions
assert "lower bound" in dispositions
