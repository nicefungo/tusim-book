...
for phrase in (
    "drops every compression and sparsity field",
    "decoder-bound",
    "raw wins ties",
    "not one integrated pipeline",
    "analytical estimate",
...
for line in (
    ...
    "SPARSITY estNarrow dense_total=",
    "SPARSITY estWide sparse_total=",
...
assert "Tests: 26 run, 25 passed, 1 failed" in (RUN / "test-sparsity-mutation.log").read_text()
