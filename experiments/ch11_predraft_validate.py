...
RUN = ROOT / RUN_REL
INPUT_COMMIT = "2e9130b3ee12f1f90c24b8ba02b8424ad12bd208"
...
assert 'CH11_RUN_ID="repro-$(date -u +%Y%m%dT%H%M%SZ)"' in report
assert "CH11_RUN_ID=20260728-ch11-canonical" not in report
