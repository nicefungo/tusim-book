...
- **Canonical retained run:** `experiments/runs/ch15-dram/20260804-ch15-canonical-v3/` (final predraft authority; v1/v2 retained)
...
Canonical v3 sealed the complete skeptical-review amendments at input commit `242807fe781be29bf39be76cfa4c2b15ca4876e5`: 23 hashes, 62 predicates/85 checks, live source mutation, static/archive gates, DRAM 12/12, hierarchy 10/10, source-linked cycle model 21/21, power 20/20, mutation inferior code 01, expanded probe, sweep recomputation, containment, manifest finalization, and 13-file predraft validation all passed. V1/v2 remain immutable history.
