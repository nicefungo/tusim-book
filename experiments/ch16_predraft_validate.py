...
RUN_ID=os.environ.get("CH16_RUN_ID","20260804-ch16-canonical-v4")
...
for line in [
 f"CH16_SOURCE_AUDIT PASS pin={PIN} hashes=31 predicates=60 checks=91",
 ...
 "ASAN_LIFECYCLE PASS detect_leaks=0 isolated_context_child=yes",
...
asan=text("asan-probe.log")
require("CH16_PROBE SUMMARY failures=0" in asan and "ERROR: AddressSanitizer" not in asan,
        "ASan lifecycle control")
