...
The final corrected provisional has an accepting candidate-bound rereview. Manuscript drafting remains blocked until its resulting postreview seal passes semantic validation, exact outer closure, normal/optimized verification, and all 13 mutation families.
